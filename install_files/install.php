...
<head>
	<title>WoWLegions - Installation</title>

	<meta charset="UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />

	<link rel="stylesheet" href="//media.wowlegions.ru/install_files/css/styles.css">
	<link rel="stylesheet" href="//media.wowlegions.ru/install_files/css/fontello-embedded.css">
	<link rel="stylesheet" href="//media.wowlegions.ru/install_files/css/animate.css">
	<link href='//fonts.googleapis.com/css?family=RobotoDraft:300,400,500,700,900' rel='stylesheet' type='text/css'>
...
<body id="install" ng-controller="InstallController">
	...
	<div class="header">
		<div class="container">
			<div class="left">
				<div class="logo">
				    <img class="img-responsive" src="https://bnetcmsus-a.akamaihd.net/cms/page_media/lx/LX1K09P4TGAZ1493065079187.png" style="width:50%" alt="logo"></div>
			...
			<ul class="wizard right">
				...
				<li ng-class="{ active: currentStep === 'info'}" class="db">3</li>
	...
	<script src="//media.wowlegions.ru/install_files/js/angular.js"></script>
	<script src="//media.wowlegions.ru/install_files/js/angular-ui-router.js"></script>
	<script src="//media.wowlegions.ru/install_files/js/installer.js"></script>
</body>
</html>