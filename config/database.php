...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'characters' => [
            'driver' => 'mysql',
            'host' => env('DB_CHARACTERS_HOST', '127.0.0.1'),
            'port' => env('DB_CHARACTERS_PORT', '3306'),
            'database' => env('DB_CHARACTERS_DATABASE', 'forge'),
            'username' => env('DB_CHARACTERS_USERNAME', 'forge'),
            'password' => env('DB_CHARACTERS_PASSWORD', ''),
            'unix_socket' => env('DB_CHARACTERS_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
        ...
        'world' => [
            ...
            'database' => env('DB_WORLD_DATABASE', 'forge'),
            'username' => env('DB_WORLD_USERNAME', 'forge'),
