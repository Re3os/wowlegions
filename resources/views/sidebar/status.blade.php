<div class="sidebar-module" id="sidebar-gear-store">
    <div class="sidebar-title">
        <h3 class="header-3 title-forums"><a href="{{ route('community-status') }}">Server Status</a></h3>
    </div>
    ...
    <div class="sts a-realm sidebar-container box-shadow">
        ...
        <div id="containerbody" class="clearfix text-shadow">
            ...
            <p id="uptime"><font color="#d28010">{{ $online->alliance + $online->horde ?: '0' }}</font> Онлайн</p>
        </div>
    </div>
