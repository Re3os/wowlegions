            ...
            <div class="dashboard service">
                <div class="primary">
                    <div class="service-wrapper">
                        <p class="service-nav">
                            <a href="/account/management/dashboard?accountName=WoW1">К управлению записью</a>
                        </p>
                                ...
                                <ul id="character-list">
                                        ...
                                        <li class="character border-4" id="WoW9:{{ $characters->guid }}:{{ $characters->name }}">
                                            ...
                                            <span class="character-name caption">
                                                <a href="{{ route('claim-code-level', ['accountName' => $userGamrAccount[0]->id , 'character' => $characters->name , 'key'=> $key]) }}" class="character-link">
                                                    {{ $characters->name }}
                                                </a>
                                            </span>
