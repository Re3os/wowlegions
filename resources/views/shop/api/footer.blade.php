            ...
            <div class="NavbarFooter-selectorDropdown">
                ...
                <div class="NavbarFooter-selectorLocales NavbarFooter-selectorSection">
                    <div class="NavbarFooter-selectorSectionBlock">
                        <a class="NavbarFooter-selectorLocale @if(App::isLocale('de-de')) is-active is-selected @endif NavbarFooter-selectorOption" href="<?= route('lang', ['lang' => 'de-de']) ?>" data-id="de-de">
                        ...
                        <a class="NavbarFooter-selectorLocale @if(App::isLocale('en-us')) is-active is-selected @endif NavbarFooter-selectorOption" href="<?= route('lang', ['lang' => 'en-us']) ?>" data-id="en-us">
                        ...
                        <a class="NavbarFooter-selectorLocale @if(App::isLocale('es-es')) is-active is-selected @endif NavbarFooter-selectorOption" href="<?= route('lang', ['lang' => 'es-es']) ?>" data-id="es-es">
                        ...
                        <a class="NavbarFooter-selectorLocale @if(App::isLocale('fr-fr')) is-active is-selected @endif NavbarFooter-selectorOption" href="<?= route('lang', ['lang' => 'fr-fr']) ?>" data-id="fr-fr">
                        ...
                        <a class="NavbarFooter-selectorLocale @if(App::isLocale('it-it')) is-active is-selected @endif NavbarFooter-selectorOption" href="<?= route('lang', ['lang' => 'it-it']) ?>" data-id="it-it">
                    ...
                    <div class="NavbarFooter-selectorSectionBlock">
                        <a class="NavbarFooter-selectorLocale @if(App::isLocale('ru-ru')) is-active is-selected @endif NavbarFooter-selectorOption" href="<?= route('lang', ['lang' => 'ru-ru']) ?>" data-id="ru-ru">
                        ...
                        <a class="NavbarFooter-selectorLocale @if(App::isLocale('ja-jp')) is-active is-selected @endif NavbarFooter-selectorOption" href="<?= route('lang', ['lang' => 'ja-jp']) ?>" data-id="ja-jp">
                        ...
                        <a class="NavbarFooter-selectorLocale @if(App::isLocale('zh-cn')) is-active is-selected @endif NavbarFooter-selectorOption" href="<?= route('lang', ['lang' => 'zh-cn']) ?>" data-id="zh-cn">
