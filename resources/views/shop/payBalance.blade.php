...
<img src="//bnetproduct-a.akamaihd.net//12/6062f75e2d7e1338a87167e7d4a842e3-prod-thumb.jpg" alt="Кошелек {{ config('app.name', 'WoWLegions') }} - {{ $amount }}&nbsp;₽" title="">
</div>
<div class="mobile-grid-100">
<div class="product-name-group">
<h6>Вы приобретаете</h6>
<p class="product-name">
Кошелек {{ config('app.name', 'WoWLegions') }} - {{ $amount }}&nbsp;₽
</p>
</div>
<div class="" id="price-breakdown">
...
<div class="liveChatContainer hide-on-mobile">
</div>
</div>
</div>
...
<div id="payment-interface" data-bnet-shop-product-id="15989"><div xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru-ru" class="fragment-wrapper ru-ru wallet7753431" data-actionfield-option="WALLET7753431" data-product-id="EU 15989" data-product-name="EU %D0%9A%D0%BE%D1%88%D0%B5%D0%BB%D0%B5%D0%BA%20Blizzard" data-product-variant="" data-product-brand="BATTLENET" data-product-category="15989" data-currency="RUB" data-base-cost="500" data-tax="0" data-show-tax="false" data-total-cost="500" data-balance-applied="0" data-total-remaining="0">
...
<div class="hide" id="checkout-payment-icons">
<div id="payment-icons-container">
<span class="control-label">Мы принимаем:</span>
<div class="controls">
<div class="accepted-payment-icons">
<span class="icon-24-payment-paypal">paypal</span>
...
<option data-icon="icon-payment-paypal" value="/shop/ru/checkout/paypal/32564836/YmJ8Y2U2YzAzODd8MTU5ODl8NTAwLjAwfHJ1Ynww">PayPal</option>
</select>
</div>
</div>
</fieldset>
<div class="balance-delay-warning-alert">
<div class="alert alert-icon">
<strong>Внимание!</strong>
Обычно кошелек {{ config('app.name', 'WoWLegions') }} пополняется в течение 3 дней после приобретения средств.
</div>
</div>
...
<a id="payment-cancel" class="cancel purchase-cancel btn btn-extra-large" href="{{ route('shop') }}" tabindex="1">
Отмена
</a>
</div>
</form>
...
<p>Средства, зачисляемые в кошелек, не подлежат возмещению и не могут быть перечислены из кошелька обратно.<br></p>
</div>
</div>
</div>
</div>
