...
//<![CDATA[
var dataLayer = [{
"analyticsViewName": "\/creation/account-creation:/creation/wow-start" , "analyticsRequestUri": "\/account/creation/ru/tos.html" , "userAgent": "web" , "authenticated": "0" , "input-order": "NULL" , "error-box": "NULL" , "error-inline": "NULL" , "theme": "wow" , "style": "" }];
...
<div class="grid-100">
<h1 class="logo">Создать запись</h1>
</div>
...
<input type="email" id="emailAddress" name="email" value="{{ $email }}" placeholder="E-mail" maxlength="320" autocapitalize="off" autocomplete="off" autocorrect="off" class="grid-100" spellcheck="false" required="true" /> <span id="emailAddress-error-inline" class="help-block"></span>
</div>
...
<div class="control-group row-password {{ $errors->has('password') ? 'control-error text-error' : '' }}">
<input type="password" id="password_confirmation" name="password_confirmation" value="" maxlength="16" placeholder="Подтвердите пароль" class="password-input showGuidelines" data-email_field="#emailAddress" autocapitalize="off" autocomplete="off" autocorrect="off" spellcheck="false" required="true" /> <div class="password-rating"></div>
<span id="password-error-inline" class="help-block"></span>
</div>
</fieldset>
<fieldset>
...
<option value="19">Марка вашей первой машины</option>
<option value="20">Название улицы, где вы жили, когда оканчивали школу</option>
<option value="21">Место, куда вы в первый раз летали самолетом</option>
<option value="22">Первая компьютерная игра, которую вы успешно прошли</option>
<option value="23">Кличка вашего второго домашнего животного</option>
<option value="24">Название любимой спортивной команды или имя любимого игрока</option>
</select>
...
<input id="receiveNewsSpecialOffersThirdParty" name="receiveNewsSpecialOffersThirdParty" type="checkbox"/>
Получать по E-mail новости и специальные предложения.<br><em>Актуальные новости, информация о мероприятиях и скидках на товары.</em>
</label>
</div>
</div>
</fieldset>
...
<span class="button-text">Создать учетную запись</span>
<i class="spinner-battlenet"></i>
</button>
<a class="btn btn-block" id="creation-cancel-button" href="{{ route('login') }}">
<span class="button-text">У вас уже есть учетная запись?</span>
<i class="spinner-battlenet"></i>
</a>
</div>
</form>
...
"message":"Требуемая длина: 8-16 символов."
},
"alphanumeric": {
"code":"account.creation.passwordrequirements.alphanumeric",
"message":"Используйте как минимум одну цифру и одну букву."
},
"specialchars": {
"code":"account.creation.passwordrequirements.specialchars",
"message":"Не используйте спецсимволы."
},
"similarname": {
"code":"account.creation.passwordrequirements.similarname",
"message":"Не используйте пароль, схожий с названием вашей учетной записи."
}
},
"errors": {
"header": {
"code":"account.creation.error.header",
"message":"Исправьте, пожалуйста, следующее."
},
"blank": {
...
"message":"Необходимо указать страну проживания."
},
"email": {
...
"message":"Адреса электронной почты не совпадают друг с другом."
},
"similar": {
"code":"error.email.similar",
"message":"Пароль не может совпадать с электронным адресом."
},
"captcha": {
"code":"error.captcha.failed",
"message":"Код безопасности введен неверно. Попробуйте еще раз."
},
"rePassword": {
"code":"account.creation.error.rePassword",
"message":"Пароль должен быть введен одинаково."
},
"password": {
...
"message":"Возраст указывается числом."
},
"agreements": {
"code":"account.creation.agreements.error.chat",
"message":"Чтобы перейти к следующему шагу, необходимо выразить согласие с соглашениями об использовании чата и борьбе с мошенничеством."
},
"unknown": {
"code":"error.unknown",
...
"serverError": {
"code":"error.403.desc",
"message":"Ой! Что-то не то. Погодите несколько минут и повторите запрос, хорошо? Мы постараемся все наладить!"
},
"countryCode": {
...
creation.requestLoginCsrfToken("/");
...
<div class="Navbar is-disabled"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" class="Navbar-embedded"><g id="Navbar-icon-new_window">
...
</svg><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 151.15 68.46" class="Navbar-embedded"><g id="Navbar-logo-blizzard">
...
</svg><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 124 66" class="Navbar-embedded"><g id="NavbarFooter-blizzard-upper">
